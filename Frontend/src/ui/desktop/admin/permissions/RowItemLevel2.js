...
class RowItemLevel2 extends Component {
    constructor(props) {
        super(props);
    }
                    ...
                    <div className="body-col widthfix80">
                        <p>
                            <RCheckbox
                                ...
                                disabled = {(item.has_child == 1 && (Libs.isBlank(item.dataLevel2) || !Libs.isArray(dataLevel2))) ? true: false}
                                />
                        </p>
                    </div>
                    <div className="body-col widthfix80">
