...
class AddCustomerPopupValidate extends BaseValidate{
    ...
    setAlias(){
        this.v.setAlias({
            first_name: trans.translate('CUSTOMER.first_name'),
            last_name: trans.translate('CUSTOMER.last_name'),
            email: trans.translate('CUSTOMER.email'),
            password: trans.translate('CUSTOMER.password')
        });
    }
}
