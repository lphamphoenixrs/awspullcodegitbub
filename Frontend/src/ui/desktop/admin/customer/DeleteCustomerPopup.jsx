...
export default function () {
    ...
    return (
        <Modal visible={true} className="modal-customer" dialogClassName="">
            <div className="modal-header">
                <h5 className="modal-title">
                    {curItem.is_delete == 0 ? trans.translate('CUSTOMER.title_delete') : trans.translate('CUSTOMER.title_retore')}
                        : {curItem.id}
                </h5>
                <button type="button" onClick={this.onCloseDeleteCustomerPopup.bind(this)} className="bootbox-close-button close" data-dismiss="modal" aria-hidden="true"><span>×</span></button>
            </div>
            ...
            <div className="modal-footer">
                ...
                <RButton
                    onClick={this.onCloseDeleteCustomerPopup.bind(this)}
