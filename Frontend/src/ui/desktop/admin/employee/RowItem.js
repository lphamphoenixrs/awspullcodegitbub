        ...
        return (
            <div className={item.is_delete == 0 ? "body-row" : "body-row is-delete"}>
                ...
                <div className="body-col width30">
                    <p>{item.fullname}</p>
                    {!Libs.isBlank(item.group_roles) ? <p className="group-role">Role:<span> {item.group_roles}</span></p> : ""}
                </div>
                ...
                <div className="body-col width10 text-right">
                    ...
                    <a title="Manage site" onClick={this.onItemClickManageSite.bind(this)} className="fnc edit"><span className="icon icon-tools"></span></a>
