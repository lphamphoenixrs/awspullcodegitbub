...
export default function () {
  ...
  var addEmployeePopupLayout = this.state.showAddEmployeePopup
    ? <AddEmployeePopup
      onCloseAddEmployeePopup={this.onCloseAddEmployeePopup.bind(this)}
      curItem={curItem}
    /> : '';
  ...
  var deleteEmployeePopupLayout = this.state.showDeleteEmployeePopup
    ? <DeleteEmployeePopup
      onCloseDeleteEmployeePopup={this.onCloseDeleteEmployeePopup.bind(this)}
      curItem={curItem}
    /> : '';

  return (
    <section className="Employees">
      {addEmployeePopupLayout}
      {deleteEmployeePopupLayout}
        ...
        <div className="row">
          ...
          <div className="col-xl-6 col-lg-6 col-md-6">
            <ul className="function-top float-right">
              ...
              <li><a className="add" onClick={this.onAddEmployeePopup.bind(this)}>Add</a></li>
            </ul>
          </div>
                ...
                <div className="box-header">
                  <div className="header-row">
                    ...
                    <div onClick={e => this.onSort(e, 'first_name')} className={searchParam.sort_column == "first_name" ?
                      "header-col width30 sorting " + searchParam.order_by : "header-col width30 sorting"}>full name</div>
